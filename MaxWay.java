...
public class MaxWay extends TelegramLongPollingBot {
    ...
    public void onUpdateReceived(Update update) {
        ...
        if (text.equals("\uD83D\uDC5CBuyurtma berish")) {
            ...
            olibketish(chatId, "olib");

        } else if (text.equals("Yetkazib berish")) {
            yetqazib(chatId, "Yetkazib");

        } else if (text.equals("MAX WAY ALAYSKIY")) {
            alayski(chatId, "ayal");

        } else if (text.equals("MAX WAY BERUNIY")) {
            Beruniy(chatId, "beruniy");

        } else if (text.equals("MAX WAY ATLAS")) {
            atlas(chatId, "atlas");

        } else if (text.equals("MAX WAY DRUJBA")) {
            drujba(chatId, "drujba");

        } else if (text.equals("MAX WAY MEGA PLANET")) {
            megaplanet(chatId, "mega");

        } else if (text.equals("MAX WAY AVIASOZLAR")) {
            aviasozlar(chatId, "avia");

        } else if (text.equals("MAX WAY RISOVIY")) {
            risoviy(chatId, "risoviy");

        } else if (text.equals("MAX WAY PARUS")) {
            parus(chatId, "parus");

        } else if (text.equals("MAX WAY MAGIC CITY")) {
            magiccity(chatId, "magic");

        } else if (text.equals("MAX WAY SAMARQAND DARVOZA")) {
            samarqanddarvoza(chatId, "sama");

        } else if (text.equals("MAX WAY PARKENT")) {
            parkent(chatId, "par");

        } else if (text.equals("MAX WAY UNIVERSAM")) {
            universam(chatId, "uni");
        ...
        } else if (text.equals("MAX WAY SAYRAM")) {
            sayram(chatId);

        } else if (text.equals("MAX WAY MAKSIM GORKIY")) {
            maksim(chatId);

        } else if (text.equals("MAX WAY FONTAN")) {
            fontan(chatId);

        } else if (text.equals("MAX WAY MINOR")) {
            minor(chatId);

        } else if (text.equals("Yangilik \uD83D\uDCE3")) {
            yangililik(chatId, "yang");

        } else if (text.equals("\uD83C\uDF5F\uD83C\uDF54\uD83E\uDD64BARAKALI Maxi BOX")) {
            maxibox(chatId);

        } else if (text.equals("\uD83E\uDD6AKlab-Sendvich")) {
            klab(chatId);

        } else if (text.equals("\uD83C\uDF2FLavash")) {
            lavash(chatId);

        } else if (text.equals("\uD83C\uDF2EShaurma va Arapita")) {
            shaurma(chatId);

        } else if (text.equals("\uD83C\uDF54Burger")) {
            burger(chatId);

        } else if (text.equals("\uD83C\uDF71Donar kebab")) {
            donarkebap(chatId);

        } else if (text.equals("\uD83C\uDF2DHot dog")) {
            hotdog(chatId);

        } else if (text.equals("\uD83C\uDF5FGazaklar")) {
            gazaklar(chatId);

        } else if (text.equals("\uD83C\uDF5ATamaddilar")) {
            tamadillar(chatId);

        } else if (text.equals("\uD83C\uDF70Desertlar")) {
            desertlar(chatId);

        } else if (text.equals("\uD83E\uDD64Ichimliklar")) {
            ichimlik(chatId);

        } else if (text.equals("☕\uFE0FIssiq ichimliklar")) {
            issiqichimliklar(chatId);

        } else if (text.equals("\uD83E\uDD6BSouslar")) {
            souslar(chatId);

        } else if (text.equals("Maxi Box Original Chicken")) {
            boxorginalchicken(chatId);

        }else if (text.equals("Maxi Box Original Beef")){
            boxorginalbef(chatId);

        }else if (text.equals("Maxi Box Traditsiya")){
            boxtradit(chatId);

        }else if (text.equals("Maxi Box Tasty")){
            boxtasy(chatId);

        }else if (text.equals("Maxi Box Popular")){
            boxpopular(chatId);

        }else if (text.equals("Maxi Box Retro")){
            boxretro(chatId);

        }else if (text.equals("Max Box German")){
            boxgerman(chatId);

        }else if (text.equals("Maxi Box Trent")){
            boxtrend(chatId);

        }else if (text.equals("Mini Box")){
            minibox(chatId);

        }else if (text.equals("\uD83C\uDF89Aksiya")){
            aksiya(chatId);

        }else if (text.equals("Arapita Chicken")){
            yanglikarapita(chatId);

        }else if (text.equals("Arapita Beef")){
            yanglikarapitabef(chatId);

        }else if (text.equals("Issiq mors Malina")){
            yanglikmorsmalina(chatId);

        }else if (text.equals("Issiq mors Kiwi-uzum")){
            yanglikmorskiwi(chatId);

        }else if (text.equals("Issiq mors Citrus-Lemongrass")){
            yablikmorscitrus(chatId);

        }else if (text.equals("ℹ\uFE0FBiz haqimizda")){
            bizxaqmzda(chatId);

        }else if (text.equals("Sendvich Original")){
            sendvcorg(chatId);

        }else if (text.equals("Klab sendvich")){
            klabsendvc(chatId);

        }else if (text.equals("Tasty Klab")){
            tastyklab(chatId);

        }else if (text.equals("Lavash mini klassik")){
            lavashminiklass(chatId);

        }else if (text.equals("Lavash mini pishloqli")){
            lavashminipishlo(chatId);

        }else if (text.equals("Lavash standart klassik")){
            lavashstandartklass(chatId);

        }else if (text.equals("Lavash standart achchiq")){
            lavashstandartachiq(chatId);

        }else if (text.equals("Lavash standart pishloqli")){
            lavashstandartpishlo(chatId);

        }else if (text.equals("Arapita Chickenn")){
            arapitachicken(chatId);

        }else if (text.equals("Arapita Beeff")){
            arapitabeef(chatId);

        }else if (text.equals("German Donar")){
            germandonar(chatId);

        }else if (text.equals("Shaurma")){
            shaurmaa(chatId);

        }else if (text.equals("Shaurma Pishloqli")){
            shaurmapishlo(chatId);

        }else if (text.equals("Gamburger")){
            gamburger(chatId);

        }else if (text.equals("Chizburger")){
            chizburger(chatId);

        }else if (text.equals("Bigburger")){
            bigburger(chatId);

        }else if (text.equals("Donar kebab")){
            donarkebab(chatId);

        }else if (text.equals("Donar Box")){
            donarbox(chatId);
        ...
        }else if (text.equals("Chiz dog")){
            chizdog(chatId);

        }else if (text.equals("Longer")){
            longer(chatId);

        }else if (text.equals("Kartoshka fri mini")){
            kartoshkakrmini(chatId);

        }else if (text.equals("Kartoshka fri standart")){
            kartoshkafristandart(chatId);

        }else if (text.equals("Kartoshka fri katta")){
            kartoshkafrikatta(chatId);

        }else if (text.equals("Po derevenski")){
            poderevenski(chatId);

        }else if (text.equals("Nagetslar 4 dona")){
            naggets4(chatId);

        }else if (text.equals("Nagetslar 6 dona")){
            naggets6(chatId);

        }else if (text.equals("Nagetslar 10 dona")){
            naggets10(chatId);

        }else if (text.equals("Nagetslar 18 dona")){
            naggets18(chatId);

        }else if (text.equals("Stripslar S(3)")){
            stripss3(chatId);

        }else if (text.equals("Stripslar M(5)")){
            stripsm5(chatId);

        }else if (text.equals("Stripslar L(7)")){
            stripsl7(chatId);

        }else if (text.equals("Naggets BOX")){
            naggetsbox(chatId);

        }else if (text.equals("Mix Box")){
            mixbox(chatId);

        } else if (text.equals("Tiramisu")) {
            tiramisu(chatId);

        } else if (text.equals("Salat")) {
            salat(chatId);

        } else if (text.equals("Guruch")) {
            guruch(chatId);

        } else if (text.equals("Brauni")) {
            brauni(chatId);

        } else if (text.equals("San sebastian")) {
            sansebastian(chatId);

        } else if (text.equals("Yo'ng'okli donat")) {
            yongoklidonat(chatId);

        } else if (text.equals("Karamel donat")) {
            karameldonat(chatId);

        } else if (text.equals("Qulupnayli donat")) {
            qulupnaylidonat(chatId);

        } else if (text.equals("Moxito")) {
            moxito(chatId);

        } else if (text.equals("Coca cola")) {
            cocacola(chatId);

        } else if (text.equals("Sprite 0,5")) {
            sprite(chatId);

        } else if (text.equals("Coca Cola 1.5L")) {
            cocacola15(chatId);

        } else if (text.equals("Fanta")) {
            fanta(chatId);

        } else if (text.equals("Coca Cola 0.5L")) {
            cocacola05(chatId);

        } else if (text.equals("Sharbat dena")) {
            sharbatdena(chatId);

        } else if (text.equals("Fuse tea")) {
            fusetea(chatId);

        } else if (text.equals("Bonaqua")) {
            bonaqua(chatId);

        } else if (text.equals("Bir martali stakan")) {
            birmartalistakan(chatId);

        } else if (text.equals("Issiq mors malina")) {
            issiqmorlmalina(chatId);

        } else if (text.equals("Qora choy")) {
            qorachoy(chatId);

        } else if (text.equals("Ko'k choy ")) {
            kokchoy(chatId);

        } else if (text.equals("Linonli choy")) {
            limonlichoy(chatId);

        } else if (text.equals("Americano")) {
            americano(chatId);

        } else if (text.equals("Kapuchino")) {
            kapuchino(chatId);

        } else if (text.equals("Latte")) {
            latte(chatId);

        } else if (text.equals("Ketchup")) {
            ketchup(chatId);

        } else if (text.equals("Pishloqli sous")) {
            pishloqlisous(chatId);

        } else if (text.equals("Sarimsoqli sous")) {
            sarimsoqlisous(chatId);

        } else if (text.equals("Ketchup chili")) {
            ketchupchili(chatId);

        } else if (text.equals("Xalapeno")) {
            xalapeno(chatId);

        } else if (text.equals("Shirin va nordon sous")) {
            shirinvanordonsous(chatId);

        } else if (text.equals("\uD83D\uDDD3Barcha filiallar")){
            barchafillial(chatId);

        }else if (text.equals("\uD83D\uDDD3Mening buyurtmalarim")){
            buyurtmlarami(chatId);

        }else if (text.equals("✍\uFE0FIzoh qoldirish")){
            izoh(update);
        }else
            buyurtma(chatId, "Buyurtma");
